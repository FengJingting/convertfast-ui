  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-14 items-center px-4 sm:px-6 lg:px-8">
        <div className="mr-4 space-x-2 hidden md:flex">
          <a href="/" className="mr-6 flex items-center space-x-1">
        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          ...
          <a 
            href="/credits" 
            className="hidden md:flex items-center text-sm hover:bg-secondary rounded-md p-2"
          >
            <div>
              <span>Credits</span>
              <span className="ml-1 hidden lg:inline">17953 / 18000</span>
            </div>
          </a>
          <button
            aria-label="Change Language"
            className="hidden md:block w-4 h-4 flex items-center justify-center hover:bg-secondary rounded-md"
          >
